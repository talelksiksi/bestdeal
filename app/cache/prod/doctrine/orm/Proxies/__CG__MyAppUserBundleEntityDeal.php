 ...
 */
class Deal extends \MyApp\UserBundle\Entity\Deal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'iddeal', 'libelle', 'typedeal', 'categorie', 'prixinitial', 'prixpromotionnel', 'datedebut', 'datefin', 'image', 'quantite', 'descriptif', 'statut', 'iduser');
        }
