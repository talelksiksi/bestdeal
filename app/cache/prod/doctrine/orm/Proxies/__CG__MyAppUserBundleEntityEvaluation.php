 ...
 */
class Evaluation extends \MyApp\UserBundle\Entity\Evaluation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'idevaluation', 'commentaire', 'note', 'iddeal', 'iduser');
        }
