 ...
 */
class Statistique extends \MyApp\UserBundle\Entity\Statistique implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'idstatistique', 'datedebut', 'datefin', 'categorie', 'iduser');
        }
    ...
    public function getIdstatistique()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdstatistique();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdstatistique', array());

        return parent::getIdstatistique();
    }
