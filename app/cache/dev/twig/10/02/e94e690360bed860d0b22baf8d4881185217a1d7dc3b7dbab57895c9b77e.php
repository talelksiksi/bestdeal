...
class __TwigTemplate_1002e94e690360bed860d0b22baf8d4881185217a1d7dc3b7dbab57895c9b77e extends Twig_Template
{
     ...
     ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["notif"]) {
            ...
            echo "</strong>
                    ...
                    <p>De: <strong>";
            // line 26
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["notif"]) ? $context["notif"] : $this->getContext($context, "notif")), "IdNotification"), "html", null, true);
            echo "</strong>
                    </p>
